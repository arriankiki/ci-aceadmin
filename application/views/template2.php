...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url()?>aceadmin/assets/css/jquery-ui.min.css" />
		<link rel="stylesheet" href="<?php echo base_url()?>aceadmin/assets/css/bootstrap-datepicker3.min.css" />
		<link rel="stylesheet" href="<?php echo base_url()?>aceadmin/assets/css/ui.jqgrid.min.css" />
		...
		<div id="navbar" class="navbar navbar-default          ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="http://localhost:8080/ci-aceadmin/" class="navbar-brand">
						<small>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo base_url()?>aceadmin/assets/images/avatars/avatar5.png" alt="Jason's Photo" />
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					<li class="">
						<a href="http://localhost:8080/ci-aceadmin/">
					...
					<li class="active open">
						...
						<ul class="submenu">
							<li class="">
								<a href="http://localhost:8080/ci-aceadmin/index.php/example">
									<i class="menu-icon fa fa-caret-right"></i>
									Simple &amp; Dynamic
								</a>
							...
							<li class="active">
								<a href="http://localhost:8080/ci-aceadmin/index.php/grid">
									<i class="menu-icon fa fa-caret-right"></i>
									jqGrid plugin
								</a>
					...
					<li class="">
						<a href="http://localhost:8080/ci-aceadmin/index.php/widgets">
					...
					<li class="">
						<a href="http://localhost:8080/ci-aceadmin/index.php/calender">
					...
					<li class="">
						<a href="http://localhost:8080/ci-aceadmin/index.php/galeri">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">ARRIAN</span>
							Application &copy; 
							<?php 
...
<![endif]-->
		...
		<script src="<?php echo base_url()?>aceadmin/assets/js/jquery.jqGrid.min.js"></script>
		<script src="<?php echo base_url()?>aceadmin/assets/js/grid.locale-en.js"></script>
